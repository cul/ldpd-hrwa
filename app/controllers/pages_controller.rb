...
class PagesController < ApplicationController
  ...
  def owner_nomination
      ...
      send_mail_owner_nomination( 'elo2112@columbia.edu' )
  ...
  def public_nomination
      ...
      send_mail_public_nomination( 'elo2112@columbia.edu' )
      flash.now[:notice] = 'Thank you.  Your nomination has been submitted.'
		end
  end
  ...
  def contact
		if(params[:contact])
      send_mail_contact( 'elo2112@columbia.edu' )
  ...
  def problem_report
      ...
      send_mail_problem_report( 'elo2112@columbia.edu' )
