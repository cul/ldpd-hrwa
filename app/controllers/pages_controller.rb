...
class PagesController < ApplicationController
  ...
  def owner_nomination
      ...
      send_mail_owner_nomination( 'culhrweb@libraries.cul.columbia.edu' )
  ...
  def public_nomination
      ...
      send_mail_public_nomination( 'culhrweb@libraries.cul.columbia.edu' )
      flash.now[:notice] = 'Thank you.  Your nomination has been submitted.'
		end
  end
  ...
  def contact
		if(params[:contact])
      send_mail_contact( 'culhrweb@libraries.cul.columbia.edu' )
  ...
  def problem_report
      ...
      send_mail_problem_report( 'hrwa-developers@libraries.cul.columbia.edu' )
