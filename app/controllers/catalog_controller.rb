...
class CatalogController < ApplicationController
  ...
  def index
    ...
    advanced_search_processing( @extra_controller_params, @configurator ) if params[ :search_mode ] == "advanced"

    # @configurator.process_params( @extra_controller_params, params )
